...
# Output file
export OUTPUT_FILE="/data01/shfiles/ra_reports/user_reco/CERFPSU1_26062024.txt"

# SQL query to find phone numbers
SQL_QUERY="SELECT EVENT_DATE,SUBMIT_DATETIME,DELIVERY_DATETIME,B_NUMBER,TRANSACTION_ID,CHILD_USER_NAME,ERROR_CODE_ID,ERROR_CODE_DESCRIPTION,ENCODING,PARTS,PLATFORM,SMS_CONTENT,FILE_NAME FROM sms_cdrs.CDRS_TEXT PARTITION(DATE_20240626) WHERE CHILD_USER_NAME='CERFPSU1';"
