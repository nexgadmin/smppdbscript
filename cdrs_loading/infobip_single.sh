#!/bin/bash
satrt1=$(date --date="-22 days" +%Y-%m-%d)
...
export path1=/data01/shfiles/infobip_loading/CDRS_LOG
export path2=/data01/shfiles/infobip_loading/cdrs/CDRS_TMP
#export path3=/var/livecdrs/ftp_data/infobip
export path4=/backup/BACKUP_CDRS
export path5=/data01/shfiles/materialized_view/cdrs/infobip/cdrs_view
#export path6=/data01/shfiles/infobip_loading/reco
export path7=/var/infobip_bkp

echo "1" >${path1}/lock.log

day0=`date --date="-22 days" +%Y_%m_%d`
